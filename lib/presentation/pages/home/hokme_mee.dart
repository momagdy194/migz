...
//                     context: context,
//                     isRefresh: true,
//                     controller: productRefresh))..add(BannerEvent.fetchLooks(
//                   context: context,
//                   isRefresh: true,
//                   controller: productRefresh))..add(BannerEvent.fetchAdsBanner(
//                   context: context,
//                   isRefresh: true,
//                   controller: productRefresh));
...
//
//               body: AllProductList(colors: colors),
//               headerSliverBuilder: (context, innerBoxIsScrolled) =>  [
//                 if (LocalStorage
//                     .getUser()
//                     .firstname != null)
//                   SliverToBoxAdapter(child: _hello(colors),),
//                 24.verticalSpace,
//
...
//                   },
//                 ),),
//                 SliverToBoxAdapter(child: BrandsTwoList(
//                     brandRefresh: brandRefresh, colors: colors),),
//                 SliverToBoxAdapter(child: CategoryTwoList(
//                     categoryRefresh: categoryRefresh, colors: colors),),
//                 SliverToBoxAdapter(child: MostProductList(colors: colors),),
//                 SliverToBoxAdapter(child: AdsList(
//                   colors: colors,
...
//                   },
//                 ),),
//                 SliverToBoxAdapter(child: NewProductList(colors: colors),),
//                 SliverToBoxAdapter(child: LooksList(
//                   colors: colors,
...
//                   },
//                 ),),
//                 SliverToBoxAdapter(child: BlogList(colors: colors)),
//                 SliverToBoxAdapter(child: AllProductList(colors: colors), ),
//                 SliverToBoxAdapter(child:
//                 80.verticalSpace,
//                 ),
//               ],
